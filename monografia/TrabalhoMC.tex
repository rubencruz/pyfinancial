...
\input{./files/processo}

\input{./files/analise}

\input{./files/arquitetura}

\input{./files/validacao}

\input{./files/metricas}

\input{./files/conclusoes}

\appendix
\input{./files/glossario.tex}
\input{./files/formulas.tex}
\input{./files/howto.tex}
\input{./files/tabelaErros.tex}
\input{./files/telas.tex}
