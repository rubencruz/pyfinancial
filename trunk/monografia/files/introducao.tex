...
É importante destacar que não foram realizados testes com nenhuma versão posterior as que foram acima relatadas. O motivo principal para a não realização desses testes é a instabilidade de algumas das novas versões.
